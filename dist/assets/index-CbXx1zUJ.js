import{a as e,i as t,n,o as r,r as i,s as a,t as o}from"./legacy-runtime-CthKYyGW.js";var s=`<main id="app-content" class="app-content is-hidden">
        <section id="library-view" class="content-grid is-catalog">
          <aside class="library-sidebar">
            <section class="panel">
              <div class="panel-header">
                <h2>上传新文章</h2>
                <span id="paper-form-status" class="status-pill">等待抓取</span>
              </div>

              <form id="paper-form" class="paper-form">
                <label class="field">
                  <span>（必填）文章网址</span>
                  <input
                    id="paper-source-url"
                ...
                <div class="browser-fetch-actions">
                  <button id="open-source-url-button" class="primary-button" type="button">
                    在浏览器打开文章网址
                  </button>
                </div>

                <button id="save-paper-button" class="primary-button" type="submit">
                  抓取并上传
                </button>
              </form>
            </section>
          ...
          <section class="library-search">
            <section class="panel">
              <div class="panel-header">
                <h2>文章和讨论列表</h2>
                <span id="paper-count" class="annotation-count">0 篇</span>
              </div>

              <p class="panel-tip">文献条目按活动时间最近排序。点击文献条目可进入新的阅读与批注页面。</p>
              ...
              <div id="paper-list" class="paper-list empty-state">
                storage 文件夹中还没有文献。
              </div>
            </section>
          </section>
...
`,c=`/home/dictation/papershare/src/client/catalog/CatalogPage.jsx`;function l(){return e(a,{children:[e(t,{showViewSwitcher:!0},void 0,!1,{fileName:c,lineNumber:9,columnNumber:7},this),e(`div`,{className:`page-shell`,children:[e(i,{},void 0,!1,{fileName:c,lineNumber:11,columnNumber:9},this),e(n,{html:s},void 0,!1,{fileName:c,lineNumber:12,columnNumber:9},this)]},void 0,!0,{fileName:c,lineNumber:10,columnNumber:7},this)]},void 0,!0)}var u=`/home/dictation/papershare/src/client/catalog/main.jsx`,d=document.getElementById(`app`);if(!d)throw Error(`Catalog root container was not found.`);r(e(l,{},void 0,!1,{fileName:u,lineNumber:11,columnNumber:8},void 0),d),o();