...
import { resetClientStoreForTests, setNavigationHandlerForTests } from "../shared/client-store.js";
...
describe("catalog page", () => {
  ...
  it("switches across the React profile and members views", async () => {
    ...
    await waitFor(() => {
      expect(document.querySelector("#member-list")?.textContent).toContain("bob");
    });
    ...
    fireEvent.click(document.querySelector("#member-profile-paper-list .ghost-button"));
  ...
  it("locks the catalog into the password view when the user must change password", async () => {
    ...
    expect(document.querySelector("#password-back-button")?.disabled).toBe(true);
    expect(document.querySelector("#library-view-button")?.disabled).toBe(true);
    expect(document.querySelector("#profile-view-button")?.disabled).toBe(true);
    expect(document.querySelector("#member-view-button")?.disabled).toBe(true);
